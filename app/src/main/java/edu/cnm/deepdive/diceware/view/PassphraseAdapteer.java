...
import edu.cnm.deepdive.diceware.view.PassphraseAdapteer.Holder;
import java.util.List;

public class PassphraseAdapteer extends RecyclerView.Adapter<Holder> {

  private final Context context;
  private final List<Passphrase> passphrases;

  public PassphraseAdapteer(Context context,
